...
tf.compat.v1.app.flags.DEFINE_string('test_data_path', '/tmp/ch4_test_images/images/', '')
tf.compat.v1.app.flags.DEFINE_string('gpu_list', '0', '')
tf.compat.v1.app.flags.DEFINE_string('checkpoint_path', '/tmp/east_icdar2015_resnet_v1_50_rbox/', '')
tf.compat.v1.app.flags.DEFINE_string('output_dir', '/tmp/ch4_test_images/images/', '')
